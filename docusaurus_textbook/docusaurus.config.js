...
const config = {
  ...
  organizationName: 'shanzeye', // Usually your GitHub org/user name.
    ...
    ({
      ...
      navbar: {
        ...
        items: [
          ...
          {
            href: 'https://github.com/Shanzeye',
            label: 'GitHub',
            position: 'right',
          },
          {
  ...
  localeConfigs: {
    ur: {
      ...
      footer: {
        ...
        copyright: `Copyright � ${new Date().getFullYear()} Physical AI & Humanoid Robotics Textbook, Built by Shanzeye.`,
      },
      prism: {
