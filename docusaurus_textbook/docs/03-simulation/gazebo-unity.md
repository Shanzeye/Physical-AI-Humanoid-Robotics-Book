...
/joint_states	Gazebo → Unity	Update avatar pose
/clock	Gazebo → Unity	Sync rendering time
/camera/pose	Gazebo → Unity	Place Unity cameras correctly
/user/cmd	Unity → Gazebo	User control / teleop
/event/signal	Unity → Gazebo	Trigger scenario changes
