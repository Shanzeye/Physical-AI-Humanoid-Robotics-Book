...
Example:
A humanoid head camera node publishes images on:
/camera/front/image_raw

A vision node subscribes to that topic and publishes detected objects on:
/vision/objects
...
Example:
A hand motor controller may expose a service:
/hand/set_grip_strength
...
Example:
A /joint_states message may include:
